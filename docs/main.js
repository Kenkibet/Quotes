...
NavbaComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavbaComponent, selectors: [["app-navba"]], decls: 14, vars: 0, consts: [[1, "navbar", "navbar-expand-sm", "navbar-dark", "bg-dark"], [1, "container"], ["href", "/", 1, "navbar-brand", "display-4"], ["type", "button", "data-toggle", "collapse", "data-target", "#collapsibleNavId", "aria-controls", "collapsibleNavId", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler", "d-lg-none"], [1, "navbar-toggler-icon"], ["id", "collapsibleNavId", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "mr-auto", "mt-2", "mt-lg-0"], [1, "nav-item", "active"], ["href", "/", 1, "nav-link"], [1, "form-inline", "ml-auto", "my-lg-0"], ["href", "/add", 1, "nav-link"]], template: function NavbaComponent_Template(rf, ctx) { if (rf & 1) {
